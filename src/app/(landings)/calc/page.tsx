...
const RegMasCalc = () => {
  ...
  const ACTUALIZADO_EL = '16/02/2026';
  ...
  const isEvaluateReady =
    fechaIngreso !== null && cincoMeses !== null && situacion !== '' && familia !== null;

  const evaluate = async () => {
    window.scrollTo({ top: 0, behavior: 'smooth' });
    const ok = await trigger(['fechaIngreso', 'cincoMeses', 'situacion', 'familia']);
    if (!ok) return;
                    ...
                    <div className="bg-white box-border w-full relative rounded-[8px] border border-solid border-[#bec8d0] p-4">
                      ...
                      <div className="flex align-center justify-start gap-x-4 mt-[14px]">
                        ...
                        <button
                          ...
                          onClick={() =>
                            setValue('familia', false, { shouldDirty: true, shouldValidate: true })
                          }
                        >
                  ...
                  <div className="flex flex-col gap-y-4">
                    <div className="bg-white box-border w-full relative rounded-[8px] border border-solid border-[#bec8d0] p-4">
                      ...
                      {(!hasEvaluated || isCalculating) && (
                        <div className="flex flex-col align-center justify-start "></div>
                      )}
                      {/** Aplica */}
                      {hasEvaluated && score >= 3 && (
                        <div className="flex flex-col align-center justify-start ">
                          <h3 className="font-bold text-[18px] text-[#2E7D32]">
                      ...
                      {hasEvaluated && (
                        <div className="flex flex-col align-center justify-start">
                          ...
                          <button
                            className="bg-[#22c55e] btn-success cursor-pointer flex items-center justify-center mt-[14px] px-[10px] py-[6px] rounded-[4px] text-center text-white"
                            type="submit"
                            disabled={sendIt}
                          >
