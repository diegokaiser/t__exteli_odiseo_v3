...
import { Breadcrumbs, FormBill } from '@/components/organisms';
import { withAuth } from '@/hocs/withAuth';

const AddBillPage = () => {
  return (
    <>
      <Breadcrumbs labels={{ customers: 'Facturación' }} pageTitle="Agregar cliente" />
      <div
...
export default withAuth(AddBillPage);
